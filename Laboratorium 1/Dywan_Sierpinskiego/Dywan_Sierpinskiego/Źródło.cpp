...
{
	glBegin(GL_POLYGON);											//rysowanie wielok¹ta - kwadratu 
	glColor3f(losuj_kolor(), losuj_kolor(), losuj_kolor());		//ustalenia koloru wierzcho³ka
	glVertex2f(x, y);											//ustalenie po³o¿enia wierzcho³ka (lewy - górny)
	glColor3f(losuj_kolor(), losuj_kolor(), losuj_kolor());		//ustalenia koloru wierzcho³ka
	glVertex2f(x + rozmiar, y - rozmiar);						//ustalenie po³o¿enia wierzcho³ka (prawy - dolny) 
	glColor3f(losuj_kolor(), losuj_kolor(), losuj_kolor());		//ustalenia koloru wierzcho³ka
	glVertex2f(x, y - rozmiar);									//ustalenie po³o¿enia wierzcho³ka (lewy - dolny)
	glColor3f(losuj_kolor(), losuj_kolor(), losuj_kolor());		//ustalenia koloru wierzcho³ka
	glVertex2f(x + rozmiar, y);									//ustalenie po³o¿enia wierzcho³ka (prawy - górny)
	glEnd();
}
